...
public class SorterMain {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			case "2":
				...
				break;
			case "3":
				bubbleSort(inputList, Integer.parseInt(size));
				break;
			case "4":
				quickSort(inputList, Integer.parseInt(size));
				break;
			case "5":
	...
	public static void bubbleSort(int[] unsorted, int size) {

	}

	public static void quickSort(int[] unsorted, int size) {
